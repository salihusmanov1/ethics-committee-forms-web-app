...
<div class="container px-4">
    ...
    <div id="main" class="main">
        ...
        <div class="mb-3 row">
            <div class="col">
                <label class="form-label">4. Does your study involve items/procedures that may jeopardize the
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="no" name="flexRadioDefault2_0"
                            {{ $form2->yes_no1 === 'no' ? 'checked' : '' }}>
        ...
        <div class="mb-3 row">
            <div class="col">
                <label class="form-label">5. Will the participants be kept totally/partially uninformed of the aim
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="no" name="flexRadioDefault2_1"
                            {{ $form2->yes_no2 === 'no' ? 'checked' : '' }}>
                        <label class="form-label-small" for="flexCheckDefault">No</label>
                    </div>
                </label>
        ...
        <div class="mb-3 row">
            <div class="col">
                <label class="form-label">6. Indicate the potential contributions of the study to your research
                    area
        ...
        <div class="mb-3 row">
            <div class="col">
                <label class="form-label"> 7. Have you completed any previous research project?
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" value="no" name="flexRadioDefault2_2"
                            {{ $form2->yes_no3 === 'no' ? 'checked' : '' }}>
                        <label class="form-label-small" for="flexCheckDefault">No</label>
                    </div>
                </label>
        ...
        <div class="row">
            <div class="col">
                ...
                <input value="{{ $form2->rname }}" name="rname" class="form-control" type="text"required>
                <br>
                <br>
                <br>
            </div>
            <div class="col">
                ...
                <input value="{{ $form2->sname }}" name="sname" class="form-control" type="text" required>
                <br>
                <br>
                <br>
            </div>
