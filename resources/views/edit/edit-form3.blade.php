...
<div class="container">
    ...
    <form _lpchecked="1" method="POST" action="{{ route('edit-form3') }}">
        @csrf
        <div class="main">
                ...
                <div class="row d-flex justify-content-between">
                    <div class="col col-sm-3">
                        <div class="form-check">
                            <input class="form-check-input" value="Ethics Committee Application Form" type="radio" name="form_list"
                    ...
                    <div class="col col-sm-3">
                        <div class="form-check">
                            <input class="form-check-input" value="Project Information Form" type="radio" name="form_list"
                    ...
                    <div class="col">
                        <div class="form-check">
                            <input class="form-check-input" value="Informed Consent Form" type="radio" name="form_list"
                        ...
                        <div class="col-3 d-flex justify-content-between">
                            ...
                            <div class="form-check mx-0">
                                <input class="form-check-input" value="Partly" type="radio" name="question_5"
                                    {{ $form3->question_5 === 'Partly' ? 'checked' : '' }}>
                            </div>
                            <div class="form-check mx-0">
                    ...
                    <div id="question-7-section">
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-between">
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Yes" type="radio"
                                        name="question_7_a" {{ $question7->a === 'Yes' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="No" type="radio"
                                        name="question_7_a" {{ $question7->a === 'No' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Partly" type="radio"
                                        name="question_7_a" {{ $question7->a === 'Partly' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="N/A" type="radio"
                                        name="question_7_a" {{ $question7->a === 'N/A' ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-between">
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Yes" type="radio"
                                        name="question_7_b" {{ $question7->b === 'Yes' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="No" type="radio"
                                        name="question_7_b" {{ $question7->b === 'No' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Partly" type="radio"
                                        name="question_7_b" {{ $question7->b === 'Partly' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="N/A" type="radio"
                                        name="question_7_b" {{ $question7->b === 'N/A' ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-between">
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Yes" type="radio"
                                        name="question_7_c" {{ $question7->c === 'Yes' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="No" type="radio"
                                        name="question_7_c" {{ $question7->c === 'No' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Partly" type="radio"
                                        name="question_7_c" {{ $question7->c === 'Partly' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="N/A" type="radio"
                                        name="question_7_c" {{ $question7->c === 'N/A' ? 'checked' : '' }}>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div id="question-8-section">
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-between">
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Yes" type="radio"
                                        name="question_8_a" {{ $question8->a === 'Yes' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="No" type="radio"
                                        name="question_8_a" {{ $question8->a === 'No' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Partly" type="radio"
                                        name="question_8_a" {{ $question8->a === 'Partly' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-between">
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Yes" type="radio"
                                        name="question_8_b" {{ $question8->b === 'Yes' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="No" type="radio"
                                        name="question_8_b" {{ $question8->b === 'No' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Partly" type="radio"
                                        name="question_8_b" {{ $question8->b === 'Partly' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                        ...
                        <div class="row">
                            ...
                            <div class="col-3 d-flex justify-content-between">
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="Yes" type="radio"
                                        name="question_8_c" {{ $question8->c === 'Yes' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
                                    <input class="form-check-input" value="No" type="radio"
                                        name="question_8_c" {{ $question8->c === 'No' ? 'checked' : '' }}>
                                </div>
                                <div class="form-check mx-0">
